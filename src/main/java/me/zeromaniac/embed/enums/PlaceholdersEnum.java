...
public enum PlaceholdersEnum {
    ...
    COMMAND_ARG_8("{arg8}"),
    COMMAND_ARG_9("{arg9}"),
    COMMAND_ARG_10("{arg10}"),
    COMMAND_ARG_11("{arg11}"),
    COMMAND_ARG_12("{arg12}"),
    COMMAND_ARG_13("{arg13}"),
    COMMAND_ARG_14("{arg14}"),
    COMMAND_ARG_15("{arg15}"),
    COMMAND_ARG_16("{arg16}"),
    COMMAND_ARG_17("{arg17}"),
    COMMAND_ARG_18("{arg18}"),
    COMMAND_ARG_19("{arg19}"),
    COMMAND_ARG_20("{arg20}"),
